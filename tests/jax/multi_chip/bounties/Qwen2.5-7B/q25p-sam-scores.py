...
def main():
    ...
    # Test with Sam's test scores math problem
    sam_scores_prompt = "Question: Sam scores 80 on the first test and 90 on the second. What score does he need on the third test to have an average of 85?"
    print(f"Prompt: {sam_scores_prompt}")
    # Generate more tokens for a more complex response
    output, peak_mem, avg_time_per_token = generate_text(model, params, tokenizer, 30, sam_scores_prompt)
