...
- JAX_ENABLE_X64 enabled for reduced FP diffs, disabled for generation speed.
...
Usage:
export JAX_ENABLE_X64=1; python q25jax3a.py --model_path weights --prompt "Janet's dogs eat 2 pounds of dog food each day. If Janet buys a 50-pound bag of dog food, how many days will it last?" --max_tokens 10 --temperature 0.7 --top_p 0.9 --top_k 50 --compare_sampling
"""
import os
import sys
import json
...
def main():
    ...
    if args.compare_sampling:
        try:
            ...
            if jax_token_id == pytorch_token_id:
                ...
                full_output = generate_text(model, params, tokenizer, full_prompt, 50, 0.7, args.top_p, args.top_k, args.repetition_penalty)
    ...
    # Disable x64 for generation speed
    original_x64 = os.environ.get("JAX_ENABLE_X64", "0")
    ...
    # Restore x64 setting
    os.environ["JAX_ENABLE_X64"] = original_x64
