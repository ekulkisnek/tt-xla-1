#!/usr/bin/env python3
"""
Test only Optimization 8: Advanced Attention with jax.nn.dot_product_attention
"""
import os
import sys
import json
...
def test_optimization8():
    """Test Optimization 8: Advanced Attention with dot_product_attention."""
    print("Testing Optimization 8: Advanced Attention with dot_product_attention")
    print("=" * 75)
    
    # Load the optimized model
    spec = importlib.util.spec_from_file_location("q25j7fast_opt8", "q25j7fast_opt8.py")
    q25j7fast_opt8 = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(q25j7fast_opt8)
    ...
    model = q25j7fast_opt8.Qwen25ForCausalLM(config=config, dtype=jnp.bfloat16)
