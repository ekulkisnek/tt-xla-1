...
def tolerance_pass(kl_div, mean_diff):
    ...
    return kl_div < 1e-7 and mean_diff < 1e-5
...
def comprehensive_equivalence_test(jax_model, jax_params, jax_tokenizer, pytorch_model, pytorch_tokenizer,
                                 ...
                                 retries=2, layer_sample=2, auto_fix_gen=True, skip_layer_wise=False):
    ...
    for prompt_idx, test_prompt in enumerate(test_prompts):
        ...
        if prompt_idx == 0:  # Enable layer-wise test by default
            ...
            try:
                ...
                @timeout(120)  # Longer timeout for layer-wise
...
def main():
    ...
    parser.add_argument("--layer_sample", type=int, default=2, help="Number of layers to sample for layer-wise test")
