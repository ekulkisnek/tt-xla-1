#!/usr/bin/env python3
"""
Test only Optimization 6: RMSNorm with rsqrt
"""
import os
import sys
import json
...
def test_optimization6():
    """Test Optimization 6: RMSNorm with rsqrt."""
    print("Testing Optimization 6: RMSNorm with rsqrt")
    print("=" * 60)
    
    # Load the optimized model
    spec = importlib.util.spec_from_file_location("q25j7fast_opt6", "q25j7fast_opt6.py")
    q25j7fast_opt6 = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(q25j7fast_opt6)
    ...
    model = q25j7fast_opt6.Qwen25ForCausalLM(config=config, dtype=jnp.bfloat16)
