...
def main():
    ...
    # JIT compile model.apply - temporarily disabled due to memory issues
    ...
    for i, (input_ids, position_ids, sample) in enumerate(pre_tokenized):
        ...
        output, peak_mem, avg_time_per_token = generate_text(model, jit_apply, params, tokenizer, 20, input_ids, position_ids, args.verbose)
