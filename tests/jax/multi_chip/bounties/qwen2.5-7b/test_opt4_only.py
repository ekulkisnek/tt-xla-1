#!/usr/bin/env python3
"""
Test only Optimization 4 (ALL optimizations combined) with a better prompt
"""
import os
import sys
import json
...
def test_optimization4():
    """Test Optimization 4 (ALL optimizations combined)."""
    print("Testing Optimization 4: ALL Optimizations Combined")
    print("=" * 60)
    
    # Load the optimized model
    spec = importlib.util.spec_from_file_location("q25j7fast_opt4", "q25j7fast_opt4.py")
    q25j7fast_opt4 = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(q25j7fast_opt4)
    ...
    model = q25j7fast_opt4.Qwen25ForCausalLM(config=config, dtype=jnp.bfloat16)
    ...
    # Better test prompt - more realistic and longer
