#!/usr/bin/env python3
"""
Test only Optimization 5: Advanced Precomputed Rotary Embeddings with complex number approach
"""
import os
import sys
import json
...
def test_optimization5():
    """Test Optimization 5: Advanced Precomputed Rotary Embeddings."""
    print("Testing Optimization 5: Advanced Precomputed Rotary Embeddings (Complex-valued)")
    print("=" * 80)
    
    # Load the optimized model
    spec = importlib.util.spec_from_file_location("q25j7fast_opt5", "q25j7fast_opt5.py")
    q25j7fast_opt5 = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(q25j7fast_opt5)
    ...
    model = q25j7fast_opt5.Qwen25ForCausalLM(config=config, dtype=jnp.bfloat16)
